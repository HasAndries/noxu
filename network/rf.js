...
function RF(spiPath, gpiopin) {
  this.gpioPin = typeof gpiopin === 'undefined' && 18 || gpiopin;
  ...
  gpio.setup(this.gpioPin, gpio.DIR_OUT, function(){
...
RF.prototype.ce = function (val, fn) {
  gpio.write(this.gpioPin, val, fn);
}
